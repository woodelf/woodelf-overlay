...
src_configure() {
	...
	local mycmakeargs=(
		...
		-DUSE_PYTHON2=OFF
		-DBoost_PYTHON3_LIBRARY_DEBUG=/usr/lib64/libboost_${EPYTHON/#python/python-}-mt.so
		-DBoost_PYTHON3_LIBRARY_RELEASE=/usr/lib64/libboost_${EPYTHON/#python/python-}-mt.so
	)
